...
void Stage2::updatePipeColour(const int& index, const bool& isConnected) {
...
void Stage2::checkNorth(const int& index, const bool& type) {
...
void Stage2::checkEast(const int& index, const bool& type) {
...
void Stage2::checkSouth(const int& index, const bool& type) {
...
void Stage2::checkWest(const int& index, const bool& type) {
...
void Stage2::checkPipeConnection(const bool& checkNewConnection) {
